            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    else
                    {
                        ...
                        return RedirectToAction("CreateBankAccount", "Home");
                    }                    
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        if((account = BankingConsole.AccountManager.createAccount(model.UserName, model.Password, model.FirstName, model.LastName)) != null)
                        {
                            Session["Username"] = model.UserName;
                            Session["AccountNumber"] = account.AccountNumber;
                            return RedirectToAction("Balance", "Home");
